  ...
  return (
    <div>
      ...
      <section className="inline-flex space-x-10 place-content-center place-items-center min-w-full mt-24">
        ...
        {/* flex flex-xol space-y-7 my-12 */}
          <div className="inline-flex space-x-2 items-center max-sm:mb-6 max-lg:mb-10 max-lg:place-content-center">
          ...
          <a href="mailto:jppuigpesce@gmail.com" className="inline-flex space-x-2 items-center max-sm:mb-6 max-lg:mb-10 max-lg:place-content-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" className="w-8 h-8 stroke-teal-400">
              <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
            </svg>
            <p className="select-all">jppuigpesce@gmail.com</p>
          </a>
          <a href="https://www.linkedin.com/in/juan-pedro-puig/" className="inline-flex space-x-2 items-center max-sm:mb-6 max-lg:mb-10 max-lg:place-content-center">
          ...
          <a href="https://github.com/jppuig" className="inline-flex space-x-2 items-center max-lg:place-content-center">
        ...
        {/* <Form method="post" className="flex flex-col space-y-7 mt-1">
          <div className="inline-flex">
            <div className="flex flex-col space-y-4 w-64 mr-4">
              ...
              <input type="text" name="subject" placeholder="Subject" className="rounded-md px-2 py-0 bg-darkBG border-borderBG border-2 focus:border-white" />
            </div>
            <textarea name="message" placeholder="Message" className="rounded-md px-2 bg-darkBG border-borderBG border-2 w-96 focus:border-white" />
          </div>
