    ...
    <div>
      ...
      <section className="grid grid-rows-3 h-min">
              ...
              <ul className="grid mt-2">
                <li className="inline-flex space-x-2 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm">C++, Java, C#, Python, SQL, JavaScript, TypeScript, Dart, Haskell, Bash, Ada</p>
                  </div>
                </li>
                <li className="inline-flex space-x-2 mb-4">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 mt-1 stroke-teal-400">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm">React, Remix, Redux, Flutter(basic), Jest</p>
                  </div>
                </li>
                <li className="inline-flex space-x-2 mb-4">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 mt-1 stroke-teal-400">
        ...
        <article className="row-span-1 inline-flex mx-48 h-20 justify-center self-center mb-16">
          ...
          {/* Jest */}
          <svg fill="#5a5a5a" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" className="w-16 mx-2 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-125 duration-150">
